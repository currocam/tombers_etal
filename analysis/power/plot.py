...
# %%
pd.read_csv("analysis/power/predictions_age_ibd.csv")["distance_km"].unique()

# %%
data = pd.read_csv("analysis/power/predictions_age_ibd.csv")
data = data.dropna()
...
# %%
plot_predictions(data2, "analysis/power/predictions_short.pdf")

# %%
plot_predictions(data2, "analysis/power/predictions_log_short.pdf", log=True)
...
# %%
plot_predictions(data3, "analysis/power/predictions_long.pdf")

# %%
plot_predictions(data3, "analysis/power/predictions_log_long.pdf", log=True)
